...
namespace Forests
{
   ...
   public:
	  ...
	  uint8 getDensityAtRaw(Ogre::Real x, Ogre::Real z, const Ogre::TRect<Ogre::Real>& mapBounds);

	  Real setDensityAt(Ogre::Real x, Ogre::Real z, const Ogre::TRect<Ogre::Real>& mapBounds, float value);
	  Real setDensityAtRaw(Ogre::Real x, Ogre::Real z, const Ogre::TRect<Ogre::Real>& mapBounds, uint8 value);
