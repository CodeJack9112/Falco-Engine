...
public:
    ...
    const Ogre::MaterialPtr &getMaterial(Perm permutation, std::string name);
    ...
    */
    ...
    public:
        ...
        virtual Ogre::MaterialPtr generateTemplateMaterial(Perm permutation, std::string name) = 0;
    };
...
protected:
    ...
    */
    ...
    const Ogre::MaterialPtr &getTemplateMaterial(Perm permutation, std::string name);
