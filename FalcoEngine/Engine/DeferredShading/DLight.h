...
public:
    ...
    */
    ...
    int getPermutation() { return mPermutation; }

    Ogre::Light* getParentLight() { return mParentLight; }
...
protected:
    ...
    */
    ...
    float oldRadius = 0;
    float oldAttenuationConstant = 0;
    float oldAttenuationLinear = 0;
    float oldAttenuationQuadric = 0;
    float oldSpotlightFalloff = 0;
    Ogre::Radian oldSpotlightInnerAngle = Ogre::Radian(0);
    Ogre::Radian oldSpotlightOuterAngle = Ogre::Radian(0);
    bool oldCastShadows = false;
