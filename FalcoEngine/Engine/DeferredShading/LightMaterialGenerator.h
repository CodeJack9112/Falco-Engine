...
{
public:
    typedef std::map<Ogre::uint32, Ogre::GpuProgramPtr> ProgramMap;
    typedef std::map<std::string, Ogre::MaterialPtr> MaterialMap;
    static ProgramMap programsV;
    static ProgramMap programsF;
