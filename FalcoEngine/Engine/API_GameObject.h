...
public:
	...
	static void Register()
	{
		...
		mono_add_internal_call("FalcoEngine.GameObject::get_attachedObject", (void*)getAttachedObject);
...
private:
	...
	//Get layer
	static MonoString* getLayer(MonoObject* this_ptr);

	//Set layer
	static void setLayer(MonoObject* this_ptr, MonoString* value);
	...
	//Get attached object
	static MonoObject * getAttachedObject(MonoObject * this_ptr);
