...
void BatchPage::_updateShaders()
{
	...
	while (it.hasMoreElements())
	{
		...
		//			if (lightingEnabled)
		//			{
		//				if (params->_findNamedConstantDefinition("objSpaceLight"))
		...
		//				if (params->_findNamedConstantDefinition("lightAmbient"))
		...
		//				if (params->_findNamedConstantDefinition("worldViewProj"))
		//					params->setNamedAutoConstant("worldViewProj", GpuProgramParameters::ACT_WORLDVIEWPROJ_MATRIX);
		//			}

		//			if (m_bFadeEnabled)
		//			{
		//				if (params->_findNamedConstantDefinition("camPos"))
		//					params->setNamedAutoConstant("camPos", GpuProgramParameters::ACT_CAMERA_POSITION_OBJECT_SPACE);

		//				//Set fade ranges
		//				if (params->_findNamedConstantDefinition("invisibleDist"))
		//				{
		...
		//				if (params->_findNamedConstantDefinition("fadeGap"))
		//				{
		...
		MaterialPtr generatedMaterial = ptrMat;
		//Apply the material
